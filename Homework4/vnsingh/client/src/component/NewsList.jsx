...
export default function NewsList() {
  ...
  async function fetchArticlesForStock(ticker) {
    ...
    try {
      ...
      // Transform backend format to match frontend display
      ...
      console.error("Failed to load news from backend:", err);
      setArticles([]);
    }
  }
  ...
  function formatDate(dateString) {
    ...
    if (isNaN(date)) return dateString; // fallback if bad date
